  ...
  try {
    ...
    switch (name) {
      ...
      case "update_card_description":
        result = await toolHandlers.handleUpdateCardDescription(args);
        break;
      case "set_card_due_date":
        result = await toolHandlers.handleSetCardDueDate(args);
        break;
      case "list_board_members":
        result = await toolHandlers.handleListBoardMembers(args);
        break;
      case "assign_card_member":
        result = await toolHandlers.handleAssignCardMember(args);
        break;
      case "unassign_card_member":
        result = await toolHandlers.handleUnassignCardMember(args);
        break;
      case "list_board_labels":
        result = await toolHandlers.handleListBoardLabels(args);
        break;
      case "add_card_label":
        result = await toolHandlers.handleAddCardLabel(args);
        break;
      case "remove_card_label":
        result = await toolHandlers.handleRemoveCardLabel(args);
        break;
